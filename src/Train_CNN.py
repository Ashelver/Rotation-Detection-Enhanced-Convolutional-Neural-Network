...
class FashionMNIST_CNNClassifier:
    def __init__(self, batch_size=64, lr=1e-3, epochs=10, device=None, save_path='../models/CNN'):
...
if __name__ == "__main__":
    classifier = FashionMNIST_CNNClassifier(batch_size=64, lr=1e-3, epochs=20)
    # classifier.train()
